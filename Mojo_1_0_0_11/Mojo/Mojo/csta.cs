...
[DllImport("csta32.dll")]
public static extern int cstaSetAgentState(UInt32 acsHandle, UInt32 invokeID, ref char [] device, AgentMode_t agentMode, ref char [] agentID, ref char [] agentGroup, ref char [] agentPassword, ref PrivateData_t privateData);

[DllImport("attprv32.dll")]
public static extern int attV6SetAgentState(ref PrivateData_t privateData, int attWorkMode, int reasonCode, Boolean enablePending);
